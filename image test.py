...
if __name__ == "__main__":
    ...
    #Json load test
    img_val = get_base64_encoded_image("/Users/giridharangovindan/PycharmProjects/finalproject/PHOTO.jpg")
    x = '{"_id":"Bach","userid":"Bach", "age":30, "city":"New York","photo":img_val,"resulttext":""}'
    y = json.loads(x)
    write_json(y)


    #update test
    # img_val=get_base64_encoded_image("/Users/giridharangovindan/PycharmProjects/finalprojectPHOTO.jpg")
    # x_updated = '{"_id":"Gary","userid":"Gary", "age":30, "city":"New York","photo":img_val,"resulttext":"This doesnot look like melanoma probably"}'
